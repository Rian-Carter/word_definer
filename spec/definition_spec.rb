...
describe ('Definition') do
  ...
  describe('#==') do
    it("is the same definition if it has the same attributes as another definition") do
      definition = Definition.new("Peacock", @word.id, nil)
      definition2 = Definition.new("Peacock", @word.id, nil)
  ...
  describe('.all') do
    it("returns a list of all definitions") do
      definition = Definition.new("In Rainbows", @word.id, nil)
      definition.save()
      definition2 = Definition.new("Peacock", @word.id, nil)
      definition2.save()
  ...
  describe('#update') do
    it("updates a definition by id") do
      definition = Definition.new("Peacock", @word.id, nil)
      definition.save()
      definition.update("Emu", @word.id)
      expect(definition.name).to(eq("Emu"))
    end
  end
